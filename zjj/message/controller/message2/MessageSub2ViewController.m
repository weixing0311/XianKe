...
@interface MessageSub2ViewController ()<UITableViewDelegate,UITableViewDataSource>
@property (weak, nonatomic) IBOutlet UITableView *tableview;
@property (nonatomic,strong)NSMutableArray * dataArray;

@end

@implementation MessageSub2ViewController
{
    int page;
    int pageSize;
}
...
-(void)getinfo
{
    ...
    [params safeSetObject:@"2" forKey:@"classId"];
...
{
    static NSString * identifier = @"MsgSub2TableViewCell";
    MsgSub2TableViewCell* cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (!cell) {
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    web.title = @"物流信息";
    NSString * orderNo = [dic safeObjectForKey:@"operationNo"];
